export const ar = {
  ...
  auction: {
    ...
    winnerNoPhone: "لا يوجد رقم هاتف للفائز — راجع المزايدات أو تواصل معه عبر يدي.",
    youWon: "مبروك — فزت بهذا المزاد! سيتواصل معك البائع لإتمام البيع.",
    callWinner: "اتصل بالفائز",
    whatsappWinner: "واتساب الفائز",
    verificationTitle: "رمز التحقق",
    verificationSellerHint:
      "اطلب من المشتري ذكر هذا الرمز قبل الاتفاق على الدفع أو التسليم. إن لم يعرفه، فليس هو الفائز.",
    verificationWinnerHint:
      "أخبر البائع بهذا الرمز عند التواصل حتى يتأكد أنك فزت بالمزاد.",
    yourBid: "مزايدتك (ج.م)",
